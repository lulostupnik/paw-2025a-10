        ...
        <div className="profile-header">
            <div className="profile-avatar-container">
                <div className="profiles-avatar">
                    ...
                    {profile.isMine && (
                        <Link
                            to="/profiles/me/edit-picture"
                            className="avatar-edit-overlay"
                            aria-label={t("profile.edit.picture.button")}
                            state={returnState}
                        >
            ...
            {profile.isMine && (
                <div className="profile-actions">
                    <div className="action-buttons-group">
                        <Link to="/profiles/me/edit" className="btn-primary btn-edit-info" state={returnState}>
                        ...
                        <Link to="/profiles/me/change-password" className="btn-secondary btn-change-password" state={returnState}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div className="profile-actions-dropdown">
                        ...
                        <div className={classNames("dropdown-menu", menuOpen && "show")} role="menu">
                            <Link to="/profiles/me/edit-picture" className="dropdown-item" state={returnState}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path>
                                    <circle cx="12" cy="13" r="4"></circle>
                                </svg>
                            ...
                            <Link to="/profiles/me/edit" className="dropdown-item" state={returnState}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                </svg>
                            ...
                            <Link to="/profiles/me/change-password" className="dropdown-item" state={returnState}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>
                                    <circle cx="12" cy="16" r="1"></circle>
                                    <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
