...
export const handlers = [
    ...
    ...createCatalogHandlers("universities", [
        { id: 1, name: "MIT", abbreviation: "MIT", links: { cityUrl: "http://localhost/webapp_war_exploded/api/cities/1", selfUrl: "http://localhost/webapp_war_exploded/api/universities/1" } },
        { id: 2, name: "Stanford University", abbreviation: "SU", links: { cityUrl: "http://localhost/webapp_war_exploded/api/cities/2", selfUrl: "http://localhost/webapp_war_exploded/api/universities/2" } },
    ...
    ...createCatalogHandlers("cities", [
        { id: 1, name: "Buenos Aires", country: "Argentina", links: { selfUrl: "http://localhost/webapp_war_exploded/api/cities/1" } },
        { id: 2, name: "Boston", country: "USA", links: { selfUrl: "http://localhost/webapp_war_exploded/api/cities/2" } },
    ...
    ...createCatalogHandlers("careers", [
        { id: 1, name: "Computer Science", links: { selfUrl: "http://localhost/webapp_war_exploded/api/careers/1" } },
        { id: 2, name: "Engineering", links: { selfUrl: "http://localhost/webapp_war_exploded/api/careers/2" } },
    ...
    ...createCatalogHandlers("interests", [
        { id: 1, name: "Travel", links: { selfUrl: "http://localhost/webapp_war_exploded/api/interests/1" } },
