...
//
//        final StringBuilder countQueryBuilder =
//                new StringBuilder("SELECT COUNT(*) FROM events e");
//        final StringBuilder queryBuilder =
//                new StringBuilder((interest != null && !interest.isEmpty())
//                        ? SQL_BASE_INTEREST : SQL_BASE);
//
//
//        if (interest != null && ! interest.isEmpty()) {
//            countQueryBuilder.
//                    append(" JOIN users us ON e.user_id = us.id JOIN user_interest ui " +
//                            "ON us.id = ui.user_id JOIN category c ON c.id = ui.category_id ");
//            filters.add("c.name = ?");
//            params.add(interest);
//        }
//
