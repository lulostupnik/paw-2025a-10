...
CREATE TABLE IF NOT EXISTS images(
    id bigint GENERATED BY DEFAULT AS SEQUENCE images_id_seq PRIMARY KEY,
    content BLOB NOT NULL
);

CREATE SEQUENCE category_id_seq START WITH 4;
CREATE TABLE IF NOT EXISTS category(
    id bigint GENERATED BY DEFAULT AS SEQUENCE category_id_seq PRIMARY KEY,
    name VARCHAR(100) NOT NULL UNIQUE
);

CREATE SEQUENCE countries_id_seq START WITH 3;
CREATE TABLE IF NOT EXISTS countries(
    id bigint GENERATED BY DEFAULT AS SEQUENCE countries_id_seq PRIMARY KEY,
    name VARCHAR(100) NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS cities(
    id bigint GENERATED BY DEFAULT AS SEQUENCE cities_id_seq PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS universities(
    id bigint GENERATED BY DEFAULT AS SEQUENCE universities_id_seq PRIMARY KEY,
    name VARCHAR(255) NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS careers(
    id bigint GENERATED BY DEFAULT AS SEQUENCE careers_id_seq PRIMARY KEY,
    name VARCHAR(255) NOT NULL UNIQUE,
    deleted BOOLEAN DEFAULT FALSE NOT NULL
);
...
CREATE TABLE IF NOT EXISTS journeys(
    id bigint GENERATED BY DEFAULT AS SEQUENCE journeys_id_seq PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS events(
    id bigint GENERATED BY DEFAULT AS SEQUENCE events_id_seq PRIMARY KEY,
    user_id BIGINT NOT NULL,
    city_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS event_responses(
    id bigint GENERATED BY DEFAULT AS SEQUENCE event_responses_id_seq PRIMARY KEY,
    user_id BIGINT NOT NULL,
...
CREATE SEQUENCE reports_id_seq START WITH 1;
CREATE TABLE IF NOT EXISTS reports (
    id bigint GENERATED BY DEFAULT AS SEQUENCE reports_id_seq PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS ratings (
    id bigint GENERATED BY DEFAULT AS SEQUENCE ratings_id_seq PRIMARY KEY,
    user_id BIGINT NOT NULL,
    event_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS tokens (
    id bigint GENERATED BY DEFAULT AS SEQUENCE tokens_id_seq PRIMARY KEY,
    user_id BIGINT NOT NULL,
