...
INSERT INTO events(user_id, city_id, event_date, event_time, address, attendees_limit, attendees_count, description, title, flyer_image_id, deleted) VALUES((SELECT id FROM users WHERE username = 'user1'), (SELECT id FROM cities WHERE name = 'city1'), CURRENT_DATE + INTERVAL '7' DAY, TIME '00:00:00', 'cool place', 30, 10, 'cool event', 'warm event', (SELECT id FROM images LIMIT 1), FALSE);
INSERT INTO events(user_id, city_id, event_date, event_time, address, attendees_limit, attendees_count, description, title, flyer_image_id, deleted) VALUES((SELECT id FROM users WHERE username = 'user2'), (SELECT id FROM cities WHERE name = 'city1'), CURRENT_DATE + INTERVAL '7' DAY, TIME '00:00:00', 'cool place', NULL, 10, 'cool event', 'another event', (SELECT id FROM images LIMIT 1), FALSE);
INSERT INTO events(user_id, city_id, event_date, event_time, address, attendees_limit, attendees_count, description, title, flyer_image_id, deleted) VALUES((SELECT id FROM users WHERE username = 'user2'), (SELECT id FROM cities WHERE name = 'city1'), CURRENT_DATE + INTERVAL '7' DAY, TIME '00:00:00', 'cool place', 30, 30, 'cool event', 'one more event', (SELECT id FROM images LIMIT 1), FALSE);
INSERT INTO events(user_id, city_id, event_date, event_time, address, attendees_limit, attendees_count, description, title, flyer_image_id, deleted) VALUES((SELECT id FROM users WHERE username = 'user1'), (SELECT id FROM cities WHERE name = 'city1'), CURRENT_DATE - INTERVAL '100' DAY, TIME '00:00:00', 'cool place', 30, 10, 'cool event', 'older event', (SELECT id FROM images LIMIT 1), FALSE);
INSERT INTO events(user_id, city_id, event_date, event_time, address, attendees_limit, attendees_count, description, title, flyer_image_id, deleted) VALUES((SELECT id FROM users WHERE username = 'user2'), (SELECT id FROM cities WHERE name = 'city1'), CURRENT_DATE + INTERVAL '7' DAY, TIME '00:00:00', 'cool place', 30, 10, 'cool event', 'deleted', (SELECT id FROM images LIMIT 1), TRUE);
