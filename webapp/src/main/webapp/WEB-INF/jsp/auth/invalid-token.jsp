...
<head>
  ...
  <title><spring:message code="invalidtoken.title"/></title>
...
<div class="auth-container">
  <div class="auth-card">
    <div class="auth-header">
      ...
      <h1 class="auth-title"><spring:message code="invalidtoken.header"/></h1>
      <p class="auth-subtitle"><spring:message code="invalidtoken.subtitle"/></p>
    </div>
    ...
    <div class="alert alert-error">
      ...
      <div class="alert-content">
        <h4 class="alert-title"><spring:message code="invalidtoken.alert.title"/></h4>
        <p class="alert-message">
              <spring:message code="invalidtoken.default.reason"/>
        </p>
      </div>
    </div>
    <div class="form-card-content">
      <div class="blocked-info">
        ...
        <p class="blocked-text"><spring:message code="invalidtoken.explanation"/></p>
