...
<div class="tab-content active" id="interests-tab">
    ...
    <c:set var="searchUrl" value="/dashboard/interests" scope="request" />
    <c:set var="searchPlaceholderCode" value="admin.search.interests" scope="request" />
    <c:set var="showAddButton" value="true" scope="request" />
    <c:set var="addButtonUrl" value="/interests/create" scope="request" />
    <c:set var="addButtonTextCode" value="interests.create.button" scope="request" />
...
<%--        </jsp:include>--%>
        ...
        <jsp:include page="../../components/pagination-with-page-number.jsp">
            ...
            <jsp:param name="baseUrl" value="/dashboard/interests?search=${param.search}" />
        </jsp:include>
