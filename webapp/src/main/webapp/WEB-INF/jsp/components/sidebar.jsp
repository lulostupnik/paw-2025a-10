...
<%--  <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-toggle-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">--%>
...
<%--        <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-close-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">--%>
...
<%--          </svg>--%>
<%--          <span class="sidebar-nav-text"><spring:message code="nav.home" /></span>--%>
<%--        </a>--%>
...
<%--          </svg>--%>
<%--          <span class="sidebar-nav-text"><spring:message code="nav.journeys" /></span>--%>
<%--        </a>--%>
...
<%--          </svg>--%>
<%--          <span class="sidebar-nav-text"><spring:message code="nav.events"/></span>--%>
<%--        </a>--%>
<%--      </div>--%>
<%--    </nav>--%>
...
<%--      <a href="<c:out value='${logoutUrl}'/>" class="sidebar-logout">--%>
<%--        <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">--%>
<%--          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />--%>
<%--        </svg>--%>
<%--        <span class="sidebar-nav-text"><spring:message code="nav.logout" /></span>--%>
<%--      </a>--%>
<%--    </div>--%>
<%--  </div>--%>
<%--</div>--%>
