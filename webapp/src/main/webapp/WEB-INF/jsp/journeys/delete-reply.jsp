...
<head>
  ...
  <title><spring:message code="journeyResponse.delete"/></title>
...
<script>
  function goBack(){
    ...
    if (rutaAnterior) {
      ...
      window.location.href = "<c:url value='/events/${journey.id}'/>"
    }
  }
</script>
<body>
    ...
    <div class="content-container">
      ...
      <div class="content-card">
        <div class="card-header">
          <h1 class="card-title"><spring:message code="journeyResponse.delete" /></h1>
        </div>
          ...
          <form:form modelAttribute="deleteReplyForm" action="${deleteReplyUrl}" method="post" class="delete-form">
            ...
            <div class="form-actions">
              ...
              <button type="submit" class="btn-danger">
                <spring:message code="journeyResponse.confirmDelete" />
              </button>
            </div>
          </form:form>
        </div>
