...
<html>
<head>
    <title><spring:message code="career.detail.title"/></title>
        ...
        <div class="featured-journey-card">
            <div class="journey-card-content">
                <div class="journey-card-header">
                    <h1 class="journey-card-title"><c:out value="${career.name}"/></h1>
                </div>
                ...
                <div class="detail-actions">
                    <a href="<c:url value='/dashboard/careers'/>" class="btn-text">
                        <spring:message code="back" text="Back"/>
                    </a>
                    <div class="hero-cta">
                        <a href="<c:url value='/careers/${career.id}/edit'/>" class="cta-button primary">
...
<div id="deleteModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <form action="<c:url value='/careers/${career.id}/delete'/>" method="post" id="deleteInterestForm">
