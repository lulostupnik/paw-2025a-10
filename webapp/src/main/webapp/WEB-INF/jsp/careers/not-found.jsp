...
<div class="container">
  ...
  <a type="button"  class="back-link" href="<c:url value="/dashboard/careers"/>">
    ...
    <spring:message code="career.back"/>
  </a>
  ...
  <div class="card">
    ...
    <%--        </svg>--%>
    <h2 class="title"><spring:message code="career.not.found.title"/></h2>
    <p class="message"><spring:message code="career.not.found.message"/></p>
  </div>
</div>
</body>
</html>
