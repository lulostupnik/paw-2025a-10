        ...
        <div class="featured-journey-card">
            <div class="journey-card-content">
                <div class="journey-card-header">
                    <h1 class="journey-card-title"><c:out value="${interest.name}"/></h1>
                </div>
                ...
                <div class="detail-content">
                    ...
                    <div class="features-grid">
                        <div class="feature-card">
                            ...
                            <p class="feature-description"><c:out value="${interest.id}"/></p>
                        </div>

                        <div class="feature-card">
                            <h3 class="feature-title"><spring:message code="interest.detail.name"/></h3>
                            <p class="feature-description"><c:out value="${interest.name}"/></p>
                        </div>
                    </div>
                </div>

                <div class="detail-actions">
                    <a href="<c:url value='/dashboard/interests'/>" class="btn-text">
                        <spring:message code="back" text="Back"/>
                    </a>
                    <div class="hero-cta">
                        <a href="<c:url value='/interests/${interest.id}/edit'/>" class="cta-button primary">
