...
public interface JourneyService {
    ...
    Page<Journey> getAllJourneys(String search, User user, String sortBy, String direction, Long destination, LocalDate startDate, LocalDate endDate, Long interest, PageParams pageParams);
